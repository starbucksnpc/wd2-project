...
<body>
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                ...
                <div class="input-group ps-5">
                    <div id="navbar-search-autocomplete" class="w-100">
                        <form method="POST" action="http://localhost:31337/project/search.php">
    ...
    <!-- Page Header-->
    <header class="masthead" style="background-image: url('http://localhost:31337/project/assets/img/raspberries.jpg');">
